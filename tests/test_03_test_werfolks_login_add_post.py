...
def test_werfolks_login_add_post(base_url,browser,browser_version,os_version,os_name,remote_flag,testrail_flag,tesults_flag,test_run_id,remote_project_name,remote_build_name):
...
if __name__=='__main__':
    ...
    if options_obj.check_options(options): 
        test_werfolks_login_add_post(base_url=options.url,
